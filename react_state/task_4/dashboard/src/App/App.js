...
class App extends React.Component {
  ...
  markNotificationAsRead = (id) => {
    // Same logic as in logIn(), to remove this time. The notification with
    // specified id will be filtered out of listNotifications, while all other
    // prevState keys kept untouched
    this.setState((prevState) => ({
      ...prevState,
