...
describe("notifications schema", () => {
  describe("getAllNotificationsByUser()", () => {
    it("should return a list containing all the context objects from the data for a userId", () => {
      const correct = [
        {
      ...
      expect(context).toEqual(correct);
    });
  });
  ...
  describe("normalized notifications", () => {
    it("should contain the correct result array", () => {
      ...
      expect(normalizedNotifications.result).toEqual(correctResult);
    });
    ...
    it("should have the correct users entity", () => {
      ...
      expect(testUser).toEqual(correctUser);
    });
    ...
    it("should have a correct notifications entity", () => {
      ...
      expect(testNotification).toEqual(correctNotification);
    });
  });
});
